...
namespace Scripts.Game
{
    public class AttributeHandle : IAttributeHandle
    {
        ...
        private float _gunReloadMultiple = 0f;
        private float _gunExtendEffectiveRangeMultiple = 0f;
        private int _gunExtendShootAmmoCount = 0;
        private int _gunExtendMagazineSize = 0;
        private int _gunExtendPenetrationCount = 0;
        private float _extendDropAmmoBoxMultiple = 0f;
        private float _extendDropHealthMultiple = 0f;
        private float _extendAmmoBoxMultiple = 0f;
        private int _nowAmmoCount;
        ...
        public AttributeHandle(IGameFiniteStateMachine gameFiniteStateMachine, PlayerData playerData, GunData gunData, MeleeData meleeData)
        {
            ...
            _nowAmmoCount = this.MagazineSize;
        }
        ...
        #region 槍械
        public int TotalAmmoCount { get => _gunData.TotalAmmoCount; set => _gunData.TotalAmmoCount = value; }
        public int NowAmmoCount { get => _nowAmmoCount; set => _nowAmmoCount = value; }
        public int MagazineSize { get => _gunData.MagazineSize + _gunExtendMagazineSize; }
        public ReloadType ReloadType { get => _gunData.ReloadType; }
        public int OneShootAmmoCount { get => _gunData.OneShootAmmoCount + _gunExtendShootAmmoCount; }
        public ShootType[] ShootTypes { get => _gunData.ShootTypes; }
        ...
        {
            return Mathf.Max((needLoadedTime ? _gunData.ReloadTime + _gunData.LoadedTime : _gunData.ReloadTime) * (1 - _gunReloadMultiple), 0.1f);
        }
        ...
        public bool NeedDropAmmoBox { get => (_gunData.DropAmmoRate + _extendDropAmmoBoxMultiple) >= Random.value; }
        public bool NeedDropHealth { get => (_playerData.DropHealthRate + _extendDropHealthMultiple) >= Random.value; }
        public int AmmoBoxCount { get => Mathf.CeilToInt(MagazineSize * (_gunData.AmmoBoxRate + _extendAmmoBoxMultiple)); }
        ...
        public Sprite AmmoSprite { get => _gunData.DropAmmoSprite; }
